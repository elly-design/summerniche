      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-12">
        <div className="grid grid-cols-1 md:grid-cols-4 gap-8">
          <div className="col-span-1 md:col-span-2">
            <h3 className="text-2xl font-bold text-orange mb-4">Summer Niche Adventures</h3>
          ...
          <div>
            ...
            <ul className="space-y-2">
              ...
              <li><Link to="/services" className="text-gray-300 hover:text-orange transition-colors">Services</Link></li>
              <li><Link to="/contact" className="text-gray-300 hover:text-orange transition-colors">Contact</Link></li>
            </ul>
          </div>
          
          <div>
            <h4 className="text-lg font-semibold text-orange mb-4">Contact Info</h4>
            <ul className="space-y-2 text-gray-300">
              ...
              <li className="flex items-center">
                ...
                info@summernicheadventures.com
              </li>
              <li className="flex items-center">
                <svg className="h-5 w-5 mr-2" fill="currentColor" viewBox="0 0 20 20">
        ...
        <div className="border-t border-gray-700 mt-8 pt-8 text-center text-gray-400">
          <p>&copy; Summer Niche Adventures. All rights reserved.</p>
          <p className="text-sm mt-2 text-orange font-semibold">Developed by Owiti TechAfrica Solutions</p>
        </div>
      </div>
    </footer>
  )
